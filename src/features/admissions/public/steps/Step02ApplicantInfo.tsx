...
import { applicantInfoSchema } from "../../validations/admissions.schema";
    ...
    <div className="md:bg-surface-elevated md:rounded-2xl md:shadow-xl p-6 md:p-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <InputText
          ...
          icon={<IconByName name="user" className="h-4 w-4" />}
        />
        ...
        <InputText
          ...
          className="md:col-span-2"
          icon={<IconByName name="idCard" className="h-4 w-4" />}
        />
        ...
        <InputText
          ...
          className="md:col-span-1"
          icon={<IconByName name="phone" className="h-4 w-4" />}
        />
        ...
        <InputText
          ...
          required
          className="md:col-span-1"
          icon={<IconByName name="calendarDays" className="h-4 w-4" />}
        />
