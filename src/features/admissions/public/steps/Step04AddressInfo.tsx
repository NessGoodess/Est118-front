...
import { addressInfoSchema } from "../../validations/admissions.schema";
import { InputText, InputSelect } from "@/components/ui/forms";
import Header from "../content/header";
import StepNavigation from "../content/StepNavigation";
import { STREET_TYPES, NEIGHBORHOOD_TYPES } from "../../types/select-types";
    ...
    <div className="md:bg-surface-elevated md:rounded-2xl md:shadow-xl p-6 md:p-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <InputText
          ...
          required
          className="md:col-span-1"
          icon={<IconByName name="map" className="h-4 w-4" />}
        />
        ...
        <InputText
          ...
          required
          className="md:col-span-1"
          icon={<IconByName name="hash" className="h-4 w-4" />}
        />
        ...
        {!showManualNeighborhood && availableColonias.length > 0 ? (
          ...
          <InputText
            ...
            required
            className="md:col-span-1"
            icon={<IconByName name="mapPin" className="h-4 w-4" />}
          />
        )}
        ...
        {!isManualCity && !isManualState ? (
          ...
          <InputText
            ...
            required
            className="md:col-span-1"
            icon={<IconByName name="building" className="h-4 w-4" />}
          />
        )}
