...
export default function AdmissionsSchoolHero({ status }: Props) {
  ...
  return (
    <section
      ...
      className="relative overflow-hidden border-b border-white/10 bg-gradient-to-br from-brand-900 via-brand-700 to-brand-500 text-white"
    >
      <div
      ...
      <div className="relative mx-auto max-w-5xl px-4 py-12 sm:px-6 md:py-16 lg:px-8">
        ...
        <p className="mb-5 flex items-center gap-3 font-mono text-xs uppercase tracking-[0.18em] text-accent-gold">
          <span className="inline-block h-px w-6 bg-accent-gold" aria-hidden />
          Portal de preinscripciones · {cycleLabel}
        </p>
