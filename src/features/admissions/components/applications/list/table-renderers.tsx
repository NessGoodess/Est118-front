...
export const tableRenderers = {
  'pre-status': (value: unknown) => {
    ...
    const map: Record<string, { label: string; cls: string }> = {
      pending: { label: 'Solicitud recibida', cls: 'bg-surface-muted text-foreground border-border' },
      in_review: { label: 'En proceso', cls: 'bg-warning/10 text-warning-foreground border-warning/30' },
      approved: { label: 'Inscrito', cls: 'bg-success/10 text-success border-success/30' },
