...
export default function AnnouncementDetailSkeleton() {
  return (
    ...
    >
      <header className="relative h-52 overflow-hidden bg-gradient-to-r from-brand-900 via-brand-700 to-brand-900 md:h-64">
        <div className="relative z-10 mx-auto flex h-full max-w-7xl items-center px-4 sm:px-6 lg:px-8">
          <div className="w-full max-w-3xl space-y-3">
            <SkeletonBone className="h-3 w-28 bg-white/20" />
            <SkeletonBone className="h-9 w-full max-w-2xl bg-white/25" />
            <div className="flex gap-2">
              <SkeletonBone className="h-6 w-24 rounded-full bg-white/15" />
              <SkeletonBone className="h-6 w-20 rounded-full bg-white/15" />
            </div>
            <SkeletonBone className="h-4 w-48 bg-white/15" />
          </div>
        </div>
      </header>
