...
export const API_ENDPOINTS = {
  ...
  ATTENDANCE: {
    ...
    DAILY_STATUSES: '/attendance/daily-statuses',
  },
  READER: {
    STATUS: '/reader/status',
    SLOTS: '/reader/slots',
    CONFIG: '/reader/config',
    SLOT: (id: number) => `/reader/slots/${id}`,
    SLOT_ARM: (id: number) => `/reader/slots/${id}/arm`,
    SLOT_START_PAIRING: (id: number) => `/reader/slots/${id}/start-pairing`,
    SLOTS_CANCEL_PAIRING: '/reader/slots/cancel-pairing',
