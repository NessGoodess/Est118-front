...
export default function LoginPage() {
  return (
    <div className="w-full max-w-5xl 2xl:max-w-6xl bg-transparent md:bg-gradient-to-br from-blue-50 to-indigo-100 rounded-2xl overflow-hidden md:shadow-2xl grid grid-cols-1 md:grid-cols-2 h-auto">
      <div className="relative hidden md:block" style={{ clipPath: "polygon(0 0, 100% 0, 90% 100%, 0% 100%)", }} >
        ...
        <div className="absolute inset-0 bg-blue-900/60 flex flex-col justify-center px-10" />
      </div>
