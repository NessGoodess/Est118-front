...
export default function HeroWelcome() {
    ...
    return (
        <section
            ...
            style={{
                /*backgroundImage: `url(${scrolled ? "/background4.png" : "/background5.png"})`,*/
        ...
        >
            ...
            */}
            ...
            <motion.div
                className={`absolute inset-0 bg-black/20 backdrop-blur-2xl ${styles.blurMask}`}
            />
            <motion.div
            ...
            >
                <h1 className="text-5xl md:text-7xl font-bold mb-6 font-montserrat text-[90px] leading-[108px] tracking-[-2.7px] " style={{ textShadow: "4px -2px 6px black" }}>
                    Escuela Secundaria <br /> <span className="text-brand-100">Técnica No. 118</span>
                </h1>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <button className="bg-primary hover:bg-primary-hover text-primary-foreground px-8 py-3 rounded-full font-semibold transition-all hover-lift">
                        Conoce Más
                    </button>
                    <button className="border-2 border-white text-white hover:bg-surface-elevated hover:text-primary px-8 py-3 rounded-full font-semibold transition-all">
                        Inscripciones
                    </button>
                </div>
            </motion.div>
