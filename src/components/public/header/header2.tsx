...
export default function Header() {
    ...
    return (
        ...
        >
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="flex flex-wrap items-center justify-end gap-4 lg:gap-6">
                            <a
                                ...
                                className="flex items-center gap-1.5 hover:text-blue-300 transition-colors text-xs lg:text-sm"
                ...
                <div className="flex items-center justify-between h-20 lg:h-24">
                    ...
                    <div className="flex items-center gap-3 lg:gap-4 flex-shrink-0">
                        ...
                        <div className="flex flex-col">
                            <h1 className={`font-bold transition-colors duration-300 ${scrolled
                                ? "text-gray-900 text-base lg:text-lg"
                    ...
                    <nav className="hidden xl:flex items-center gap-1">
                        ...
                        >
                            ...
                            {/* Dropdown Menu */}
                            {servicesOpen && (
                                <div className={`absolute top-full right-0 mt-2 w-72 rounded-xl shadow-2xl overflow-hidden z-50 ${scrolled ? 'bg-white' : 'bg-white/98 backdrop-blur-sm'
                                    }`}>
                                    ...
                                    <div className="py-2">
                                        {studentServicesLinks.map((service) => (
                                            <button
                                                ...
                                                className="w-full px-4 py-3 flex items-start gap-3 hover:bg-blue-50 transition-colors duration-150 text-left group"
                                            >
            ...
            {/* Menú móvil */}
            {mobileOpen && (
                <div className={`lg:hidden border-t transition-colors duration-200 ${scrolled ? "bg-white border-gray-200" : "bg-[#181d49]/95 border-white/10 backdrop-blur-sm"
                    }`}>
