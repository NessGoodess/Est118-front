  ...
  return (
    <div className="md:bg-surface-elevated md:rounded-2xl md:shadow-xl p-6 md:p-12">
      ...
      >
        ...
        <ul className="pl-2 list-disc space-y-2 text-justify text-foreground">
          <li >
          ...
          <li>
            ...
            <a href="https://www.facebook.com/EscSecTecnica118" target="_blank" rel="noopener noreferrer"
              ...
              className="block mt-1 text-primary underline font-semibold break-all hover:text-primary-hover"
            >
              EscSecTecnica118
            </a>
          </li>
