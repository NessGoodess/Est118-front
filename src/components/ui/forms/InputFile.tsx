        ...
        <div className={`w-full ${className}`}>
          ...
          `}>
            ...
            <div className="text-center">
              {filePreview ? (
                <div className="mb-4">
                  <Image src={filePreview} alt="Preview" width={160} height={160} className="max-h-40 mx-auto rounded-lg shadow-md" />
                </div>
              ) : (
                <svg className={`w-12 h-12 mx-auto mb-3 ${hasError ? 'text-red-400' : 'text-slate-400'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
